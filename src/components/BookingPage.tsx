    ...
    return (
      <div className={`max-w-xl mx-auto bg-white rounded-2xl border border-slate-100 shadow-sm p-8 text-center ${typographyClass}`}>
        ...
        <p className="text-slate-500 text-sm mt-2">
          An email confirmation has been dispatched to <strong className="text-indigo-600 font-bold">{justBooked.clientEmail}</strong>. Please check your inbox for details!
        </p>
          ...
          <form onSubmit={handleBookAppointment} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex flex-wrap gap-1.5 pt-1">
                <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-indigo-50 border border-indigo-150 rounded text-[10px] font-medium text-indigo-700">
                  ✓ Public Guest Booking (No Login Required)
                </span>
                <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-emerald-50 border border-emerald-150 rounded text-[10px] font-medium text-emerald-700">
                  ✓ Instant Email Confirmation Sent to Client
                </span>
              </div>
            </div>
